...
mkdir W
cd /c/W
git clone https://github.com/GTMA/MuseumInterface.git MuseumInterface
```
...
3. Open `C:\W\MuseumInterface-rel\MuseumInterface.sln`, select `Release` and build the project.
...
cmake -G "Visual Studio 14 2015 Win64" -DQT_QMAKE_EXECUTABLE:PATH=C:\Qt\5.9.1\msvc2015_64\bin\qmake.exe ..\MuseumInterface
